"""
    ...
    A block to calculate Kalman Gain of Kalman Filter module
"""
import gras
import numpy

class KalmanGain(gras.Block):
    '''
        Kalman Gain block
        Required Paramters:
        H: Observation Matirx

        Inputs:
            Takes Covariance innovation S and Covariance Prediction Pn
        which gives out a gain for Kalman Filter K
    '''
    ...
    def work(self, input_items, output_items):
        ...
        self.produce(0, len(k)) # Produce from port 0 output_items
